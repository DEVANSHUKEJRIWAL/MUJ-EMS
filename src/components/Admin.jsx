...
const Admin = () => {
    ...
    const handleAddElective = async (e) => {
        ...
        if (!validateElectiveName(branch) || !validateElectiveName(elective) || !seats || !description || !validateElectiveName(faculty) || !facultyId) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!validateStudentName(studentName) || !regNo || !programElective || !branch) {
            alert('Please fill in all fields with valid data');
            return;
        }
        ...
        <div>
            ...
            <div className="side-panel">
                ...
                <div class="ser-container">
                    ...
                    <input class="ser-input" type="text" placeholder="Search..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                </div>
